...
Que No se podia casi disfrutar del rato de descanso por tener que estar esperando,

Que Terminás pasando el recreo en la fila en vez de descansando y terminas llegando tarde a la clase por esperar la comida.

Y del lado de los trabajadores:
Que ha pasado de dejar alumnos sin poder ser atendidos, ya que no da el tiempo.

O que Es difícil atenderlos a todos con la rapidez que demandan. Ya que todo es una locura y una desorganización.

Estas no son situaciones excepcionales. Sino que son el día a día.
...
El primero es la **incertidumbre de tiempo**: nadie sabe cuánto va a esperar, y esa duda lleva a muchos a no ir directamente.

El segundo es la **comunicación fragmentada**: el pedido pasa por tres instancias —cliente, caja, cocina— en voz alta y a mano. Cada transmisión es una oportunidad de error.

El tercero es la **autonomía del estudiante**: quieren poder actuar sin depender de que alguien los atienda en ese momento.

Y el cuarto es la **carga operativa del personal**: Gabriela y Maximiliano saben exactamente qué va a pasar en el pico. Por lo tanto el conocimiento existe, pero no hay un sistema que lo este aprovechando.
...
El segundo: que los estudiantes necesitan **conocer con anticipación los tiempos de espera y la disponibilidad de productos**, porque toman decisiones de compra en función del tiempo limitado que tienen entre clases.

El tercero: que un estudiante que depende de la cafetería necesita una alternativa que **reduzca significativamente los tiempos de espera**, porque no siempre tiene la posibilidad de abandonar la fila o buscar otra opción.

Y el cuarto, desde el lado del personal: que necesitan una **forma más eficiente de organizar pedidos, cobros y preparación**, porque la concentración de estudiantes en períodos muy cortos genera sobrecarga operativa y dificulta atender a todos a tiempo.
...
La cual es una app móvil con dos interfaces conectadas. El estudiante elige del menú del día, confirma el pedido desde el celular, y llega a la cafetería solo a retirar. Del otro lado, el personal ve todos los pedidos entrantes en tiempo real y puede anticipar la preparación antes de que empiece el pico.

Esta aplicacion cuenta con Cuatro funcionalidades clave: **pedido anticipado**, **seguimiento en tiempo real** del estado del pedido, **múltiples métodos de pago**, incluyendo efectivo y un **panel de gestión** para el personal.

Gracias a esto, pasamos de un sistema donde todos llegan al mismo tiempo a pedir, a uno donde la cocina ya sabe qué viene antes de que lleguen.
...
Hicimos pretotipos de por ejemplo el login, el menú principal, el carrito y el panel del personal. Y los mostramos a potenciales usuarios para ver si la lógica tenía sentido sin necesidad de invertir tiempo en tecnología.

La respuesta fue inmediata: entendieron el flujo solos, sin explicación.
...
Realizamos las pantallas para los dos flujos completos: el flujo del estudiante — desde el login hasta el seguimiento del pedido — y el panel del personal.

El prototipo tiene el nivel de detalle suficiente para que un usuario real lo navegue y tome decisiones, lo que nos permitió hacer pruebas significativas.
...
Lo Primero seria: integrar medios de pago locales — Mercado Pago, tarjetas de debito y credito, u cualquier otro tipo de pago cotidiano

Segundo: un **piloto acotado en una cafetería**, para validar el flujo en condiciones reales antes de escalar.

Tercero: si el modelo funciona, replicarlo en otros puntos de venta del campus — fotocopias, librería, y más.
